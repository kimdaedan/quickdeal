        ...
        <form id="product-offer-form" action="{{ route('penawaran.store_product') }}" method="POST">
            ...
            <fieldset class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        <label for="client_details" class="block text-sm font-medium text-gray-600">Detail / Alamat (Opsional)</label>
            ...
            <div class="mt-8 pt-6 border-t grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-50 p-4 rounded-lg h-fit">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="hilangkan_grand_total" name="hilangkan_grand_total" type="checkbox" value="1" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded cursor-pointer">
                        </div>
                ...
                <div class="bg-blue-50 p-6 rounded-lg flex flex-col gap-3">
                    ...
                    <div class="mt-4">
                        <button type="submit" class="w-full bg-blue-600 text-white font-bold py-4 px-6 rounded-lg hover:bg-blue-700 transition shadow-lg text-lg flex items-center justify-center gap-2">
                             <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" />
                            </svg>
                            Simpan Penawaran Produk
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="item-row bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm relative mb-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
            <div class="md:col-span-8">
                ...
                <input type="text" class="nama-produk-input w-full rounded-md border-gray-300 text-base py-2 px-3 shadow-inner"
                       list="list-produk-db"
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" class="keterangan-input w-full rounded-md border-gray-300 text-sm py-2 px-3"
