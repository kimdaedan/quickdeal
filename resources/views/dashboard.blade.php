    ...
    <div class="container mx-auto max-w-6xl px-4 -mt-28 relative z-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-xl border-l-8 border-emerald-500 flex items-center justify-between relative overflow-hidden">
                <div class="relative z-10">
                    <p class="text-gray-500 font-bold uppercase text-xs tracking-wider mb-2">Total Sisa Piutang</p>
                    <h2 class="text-3xl font-extrabold text-gray-800">
                        Rp {{ number_format(\App\Models\Invoice::sum('sisa_pembayaran'), 0, ',', '.') }}
                    </h2>
                    <p class="text-emerald-500 text-sm mt-2 font-medium">Tagihan Berjalan (Belum Lunas)</p>
                </div>
