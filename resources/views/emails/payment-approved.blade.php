...
<head>
    ...
    <title>Pembayarans Invoice Disetujui</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03); border: 1px solid #e2e8f0; overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 35px 20px; color: #ffffff;">
                            ...
                            <p style="margin: 8px 0 0 0; font-size: 13px; color: #d1fae5; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Pembayaran Disetujui</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #475569;">
                                Kami menginformasikan bahwa bukti transfer yang Anda unggah untuk invoice <strong>{{ $invoice->no_invoice }}</strong> telah **disetujui** dan diverifikasi oleh admin.
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 30px;">
                                ...
                                <tr>
                                    <td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0; background-color: #ecfdf5;">
                                        <span style="font-size: 11px; font-weight: 650; color: #059669; text-transform: uppercase; display: block; margin-bottom: 4px;">Jumlah Pembayaran Diverifikasi</span>
                                        <span style="font-size: 16px; font-weight: 800; color: #047857;">Rp {{ number_format($payment->jumlah, 0, ',', '.') }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                                        ...
                                        <span style="font-size: 14px; font-weight: 500; color: #0f172a;">{{ $payment->keterangan }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 16px 20px; background-color: #f0fdf4;">
                                        <span style="font-size: 11px; font-weight: 650; color: #059669; text-transform: uppercase; display: block; margin-bottom: 4px;">Sisa Tagihan Saat Ini</span>
                                        <span style="font-size: 14px; font-weight: 700; color: #047857;">
                            ...
                            <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #64748b; text-align: center;">
                                Terima kasih telah melakukan pembayaran tepat waktu. Info lebih lanjut dapat diakses di dashboard Anda.
                            </p>
                        </td>
                    </tr>
