...
<head>
    ...
    <title>Aturs Ulang Kata Sandi Anda</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 580px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03); border: 1px solid #e2e8f0; overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #1e3a8a 0%, #2563eb 100%); padding: 40px 20px; color: #ffffff;">
                            ...
                            <p style="margin: 10px 0 0 0; font-size: 14px; color: #bfdbfe; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em;">Pemulihan Kata Sandi</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #475569;">
                                Anda menerima email ini karena kami menerima permintaan untuk mengatur ulang kata sandi akun Anda di <strong>Quick.Deal</strong>.
                            </p>
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #475569;">
                                Tautan atur ulang kata sandi ini akan kedaluwarsa dalam waktu <strong>{{ $count }} menit</strong>.
                            </p>
                            ...
                            <div style="background-color: #fffbeb; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 6px; margin-bottom: 24px;">
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #b45309; font-weight: 500;">
                                    <strong>Perhatian Keamanan:</strong> Jika Anda tidak meminta pengaturan ulang kata sandi ini, tidak ada tindakan lebih lanjut yang diperlukan. Keamanan akun Anda tetap aman.
                                </p>
                            </div>
