        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="text-center">
                ...
                <div class="mt-4 text-xs text-slate-500">
                    Butuh bantuan masuk atau kendala teknis? <br>
                    <a href="https://wa.me/6281393044942?text=Halo%20Admin%20Quick.Deal,%20saya%20mengalami%20kendala%20masuk%20ke%20aplikasi..." 
                       target="_blank" 
