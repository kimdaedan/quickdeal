...
<head>
    ...
    <title>Atur Ulang Password - Quick.Deal</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen py-8">
    ...
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Buat kata sandi baru Anda untuk dapat mengakses kembali akun Anda.</p>
        </div>

        @if ($errors->any())
            <div class="mb-5 bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-lg text-sm" role="alert">
                <p class="font-bold mb-1">Gagal Mengubah Password</p>
            ...
            <div class="mb-4 relative">
                ...
                <div class="relative">
                    <input type="password" name="password" id="password"
                           ...
                           placeholder="••••••••"
                           required autofocus>
                    <button type="button" onclick="togglePassword('password', 'eye-open', 'eye-closed')" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none">
            ...
            <div class="mb-6 relative">
                ...
                <div class="relative">
                    <input type="password" name="password_confirmation" id="password_confirmation"
                           ...
                           placeholder="••••••••"
                           required>
                    <button type="button" onclick="togglePassword('password_confirmation', 'eye-open-confirm', 'eye-closed-confirm')" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none">
