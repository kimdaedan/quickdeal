...
<div class="container mx-auto my-12 px-4">
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 md:p-12 shadow-lg rounded-lg" id="surat-penawaran">
        ...
        @if($showTotal)
        <section class="mt-4 flex flex-col items-end gap-2" id="grand-total-block">
            @if($offer->diskon_global > 0)
            <div class="w-full md:w-6/12 bg-red-50 text-red-700 p-2 border border-red-100 rounded-lg flex justify-between">
